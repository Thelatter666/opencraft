...
| T-I1 | **物品与库存模型（无头库）** | **done（已合入 main，297/297）** | act_mu32p1nn_5f00c39a5e3c | PM 干净检出 297/297；独立核算 267+30(7+6+17)=297 成立；`game/client`/`engine` 零 diff；41 格（9+27+4+1）；裁决 `T-I1.ruling.md`（S-2 采 (a) ItemDef 加 u16 block、S-3 删 still_water、S-4 副手确认） |
