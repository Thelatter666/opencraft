...
WANT = {
    "mossback": {
        ...
        # ★ T-B5 追加需求（用户 2026-09-18「一定要有明显的面部特征」）：格 10 由 U0 改 O0
        9: (0x1E, 0x1E, 0x22), 10: (0x28, 0x28, 0x2C), 11: (0x1E, 0x1E, 0x22),
...
PAINTED = {
    "mossback": [1, 2, 3, 4, 5, 6, 7, 10, 17, 18, 19, 20, 21, 22, 23, 24],
