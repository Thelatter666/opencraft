#!/usr/bin/env python3
"""T-B2 · 把两份**手写的**字符稿翻译成 assets/ 下的两个文件。

用法：
    python3 vox_build.py <worktree_root>

    读  <root>/docs/qa/T-B2-2026-09-18/tools/mossback_layers.txt
    读  <root>/docs/qa/T-B2-2026-09-18/tools/mossback_palette.txt
...
SWATCH_FOR_INDEX = {
    ...
    9: "C", 10: "A", 11: "E", 12: "I", 13: "G", 14: "F", 15: "H", 16: "J",
}
...
def main():
    ...
    print(f"body-group colours (9+): {[i for i in used if i >= 9]}")
